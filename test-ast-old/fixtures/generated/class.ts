...
//
////////////////////////////////////////////////////////////////////////////////
	import { DateChooserDataGrid } from "./supportClass/DateChooserDataGrid";
	import { YearNavigatorSpinner } from "./supportClass/YearNavigatorSpinner";
	import { DateChooserScrollEvent } from "../events/DateChooserScrollEvent";
	import { DateChooserScrollEventDetail } from "../events/DateChooserScrollEventDetail";
	import { DateChooserSelectionEvent } from "../events/DateChooserSelectionEvent";

	import { Event } from "../../../../flash/events/Event";
	import { MouseEvent } from "../../../../flash/events/MouseEvent";

	import { ArrayList } from "../../../../mx/collections/ArrayList";
	import { IList } from "../../../../mx/collections/IList";
	import { DateChooser } from "../../../../mx/controls/DateChooser";
	import { IVisualElement } from "../../../../mx/core/IVisualElement";
	import { DateChooserEventDetail } from "../../../../mx/events/DateChooserEventDetail";
	import { FlexEvent } from "../../../../mx/events/FlexEvent";
	import { IFocusManagerComponent } from "../../../../mx/managers/IFocusManagerComponent";

	import { CellPosition } from "../../../../spark/components/gridClasses/CellPosition";
	import { GridColumn } from "../../../../spark/components/gridClasses/GridColumn";
	import { GridSelectionMode } from "../../../../spark/components/gridClasses/GridSelectionMode";
	import { ButtonBase } from "../../../../spark/components/supportClasses/ButtonBase";
	import { SkinnableComponent } from "../../../../spark/components/supportClasses/SkinnableComponent";
	import { IDisplayText } from "../../../../spark/core/IDisplayText";
	import { GridEvent } from "../../../../spark/events/GridEvent";
	import { GridSelectionEvent } from "../../../../spark/events/GridSelectionEvent";
	...
	export class DateChooser extends SkinnableComponent implements IFocusManagerComponent
	{
		 ...
		 *  @productversion Flex 3
		 */
		public get selectableRange():any
		{
		 ...
		 *  @private
		 */
		public set selectableRange(value:any)
		{
		 ...
		 * @private
		 */
		/*override*/ protected partAdded(partName:string, instance:any):void {
		 ...
		 * @private
		 */
		/*override*/ protected partRemoved(partName:string, instance:any):void {
		 ...
		 */
		private gridLabelFunction(weekObject:any,column:GridColumn):string {
			if(weekObject) {
		 ...
		 */
		private dateInRange(date:Date, range:any):boolean
		{
		...
		private getDateForCell(rowIndex:number,columnIndex:number):Date {
			if(this.gridDataProvider && this.gridColumns && rowIndex >=0 && rowIndex <7 && columnIndex >=0 && columnIndex < 7) {
				var week:any = this.gridDataProvider.getItemAt(rowIndex);
...
for (i in this.disabledRanges) {
		 ...
		 */ 
		private scrubTimeValue(value:any):any
		{
